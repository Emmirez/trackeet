  ...
  },
  {
    ...
    articles: [
      ...
      },
      {
        ...
        content:
          "Select Bank Transfer on the subscription page. Transfer the exact amount to our GTBank account (Trackeet Technologies Ltd, 0123456789). Email your proof of payment to hello@gettrackeet.com with your email as reference.",
      },
      {
        title: "How to get a refund",
        content:
          "We offer a 7-day refund policy. Email hello@gettrackeet.com within 7 days of payment with your transaction reference. Refunds are processed within 3–5 business days.",
      },
      {
