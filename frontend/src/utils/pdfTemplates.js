...
export const classicTemplate = (inv, bizName, bizAddress) => {
  ...
  doc.text(bizAddress || "trackeet.ng", 15, 34);
  ...
  doc.setFontSize(8);
  doc.text(
    `Generated by ${bizName || "Trackeet"} • trackeet.ng • Thank you for your business`,
    105,
    292,
    { align: "center" },
  );
...
export const minimalTemplate = (inv, bizName, bizAddress) => {
  ...
  doc.setFontSize(9);
  doc.setTextColor(...gray);
  doc.text(bizAddress || "trackeet.ng", 14, 30);
...
export const boldTemplate = (inv, bizName, bizAddress) => {
  ...
  doc.setFontSize(9);
  doc.setTextColor(...gray);
  doc.text(bizAddress || "trackeet.ng", 14, 33);
...
export const warmTemplate = (inv, bizName, bizAddress) => {
  ...
  doc.setFontSize(9);
  doc.setTextColor(...gray);
  doc.text(bizAddress || "trackeet.ng", 14, 39);
